...
class JustificationProcessor(DataProcessor):
    def get_train_examples(self, data_dir):
        """See base class."""
        return
...
def convert_examples_to_features(examples, max_seq_length,
    ...
    for (ex_index, example) in enumerate(examples):
        ...
        tokens_b = None
        if example.text_b: # only if input is a pair
...
def main():
    ...
    parser.add_argument("--model_file",
                        ...
                        type=str,
                        required=True,
                        help="Model file for pretrained model.")
    ...
    processors = {
        "justification": JustificationProcessor,
    }
